...
const bags = targetDb.bags.find({}, { _id: 1, manifest_id: 1, number: 1 }).toArray();
const shipments = targetDb.shipments.find(
  {},
  { _id: 1, manifest_id: 1, bag_id: 1, bag_number: 1, print_order: 1 },
).toArray();
...
if (orphanBags.length || invalidShipments.length || duplicatePrintOrders) {
